...
# jq --indent 4 '{"homepage":"https://xxx.yy/sill-preprod"} + .' web/package.json > web/temp.json && mv web/temp.json web/package.json

sed -i 's|base: "\/"|base: "\/sill-preprod"|g' web/vite.config.ts
